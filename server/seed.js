...
async function runSeed() {
  ...
  try {
    ...
    const products = [
      { slug: 'luminous-silk-cleanser', name: 'Luminous Silk Cleanser', tagline: 'Cleanser', price: 5500, img: '/products/WhatsApp Image 2026-06-13 at 7.55.40 AM.jpeg', desc: 'A silky, low-foaming medical cleanser infused with botanical extracts that removes impurities while respecting the skin barrier.', order: 1 },
      { slug: 'cellular-hydration-serum', name: 'Cellular Hydration Serum', tagline: 'Serum', price: 8500, img: '/products/WhatsApp Image 2026-06-13 at 7.55.41 AM (1).jpeg', desc: 'A multi-weight hyaluronic acid serum designed to lock in deep hydration at the cellular level for a plump, glowing finish.', order: 2 },
      { slug: 'restorative-barrier-cream', name: 'Restorative Barrier Cream', tagline: 'Moisturizer', price: 9000, img: '/products/WhatsApp Image 2026-06-13 at 7.55.41 AM (2).jpeg', desc: 'Intensive repair cream formulated with ceramides and clinical peptides to strengthen, soothe, and recover post-treatment skin.', order: 3 },
      { slug: 'radiance-retinol-treatment', name: 'Radiance Retinol Treatment', tagline: 'Treatment', price: 11000, img: '/products/WhatsApp Image 2026-06-13 at 7.55.41 AM (3).jpeg', desc: 'Micro-encapsulated slow-release retinol that refines skin texture, accelerates cell turn-over, and diminishes fine lines.', order: 4 },
      { slug: 'vitamin-c-glow-concentrate', name: 'Vitamin C Glow Concentrate', tagline: 'Serum', price: 9500, img: '/products/WhatsApp Image 2026-06-13 at 7.55.41 AM (4).jpeg', desc: 'Potent 15% L-Ascorbic Acid serum with Ferulic Acid to neutralize environmental free radicals and brighten uneven pigment.', order: 5 },
      { slug: 'mineral-shield-spf-50', name: 'Mineral Shield SPF 50', tagline: 'Protection', price: 4800, img: '/products/WhatsApp Image 2026-06-13 at 7.55.41 AM (5).jpeg', desc: 'A lightweight, tinted physical sunscreen offering broad-spectrum protection with a flawless, dewy, non-greasy texture.', order: 6 },
      { slug: 'absolute-eye-lift-gel', name: 'Absolute Eye Lift Gel', tagline: 'Eye Care', price: 7500, img: '/products/WhatsApp Image 2026-06-13 at 7.55.41 AM.jpeg', desc: 'Cooling peptide eye gel designed to drain puffiness, reduce dark circles, and lift structural lines around the orbital area.', order: 7 },
      { slug: 'smoothing-exfoliating-polish', name: 'Smoothing Exfoliating Polish', tagline: 'Exfoliator', price: 5000, img: '/products/WhatsApp Image 2026-06-13 at 7.55.42 AM (1).jpeg', desc: 'Fine micro-polishing clinical scrub utilizing salicylic acid and quartz crystals to sweep away superficial build-up.', order: 8 },
      { slug: 'clarifying-salicylic-elixir', name: 'Clarifying Salicylic Elixir', tagline: 'Treatment', price: 6500, img: '/products/WhatsApp Image 2026-06-13 at 7.55.42 AM.jpeg', desc: 'Targeted BHA toner that penetrates deep into pores to dissolve sebum, clear blackheads, and prevent active breakouts.', order: 9 }
    ];
