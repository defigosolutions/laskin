        ...
        >
          ...
          <div className="reveal-in" style={{ animationDelay: '0.2s' }}>
            ...
            <h2 className="section-title" style={{ textAlign: 'left' }}>
              A Heritage of Rejuvenation & Timeless Harmony
            </h2>
            ...
            <p style={{
              ...
              Founded in Beverly Hills and expanded to global luxury destinations in London and Dubai, <strong>LA Skin & Aesthetics</strong> combines cutting-edge clinical technology with a serene, high-society medical spa atmosphere.
            </p>
            ...
            <p style={{
              ...
              Our clinical philosophy centers around custom anatomical skin mapping, focusing on restoring optimal cellular health and highlighting your natural features without looking artificial or overdone.
            </p>
